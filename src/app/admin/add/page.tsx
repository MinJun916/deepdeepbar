    ...
    <main className="min-h-screen bg-[radial-gradient(120%_90%_at_50%_0%,#fcf8f2_0%,#f3ece2_56%,#ece2d6_100%)] text-[#1f2937]">
      <div className="mx-auto w-full max-w-3xl px-4 pb-16 pt-10 sm:px-6">
        ...
        {!canUseSupabaseAdmin ? (
          ...
          >
            <select name="category" className="rounded-lg border border-[#d7cec2] bg-white px-3 py-2" defaultValue="cocktail" required>
            ...
            <input name="name" placeholder="name" className="rounded-lg border border-[#d7cec2] bg-white px-3 py-2" required />
            <input
              name="name_en"
              placeholder="name_en"
